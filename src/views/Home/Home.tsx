...
function Home() {
  ...
  const [homeImage, setHomeImage] = useState(
    getValue(remote, "home_image").asString()
  );
  useEffect(() => {
    ...
    <div className="flex-column flex-align-center">
      ...
      <div className="mt-3 p-2 flex-row flex-align-center">
        <img
          ...
          src={HundredPercentImage}
        />
        <div className="flex-column flex-center-left">
          <small style={{ fontSize: 14, fontWeight: 600 }}>
            Fluency is 100% policy-free
          </small>
          <small style={{ textAlign: "start" }}>
            We do not restrict our clients, regardless of their nationality
          </small>
      ...
      <small className="text-medium">
        Want to join our dev team? Contacts: t.me/Andriannicolaev
      </small>
    </div>
  );
}
